...
public class ArrayCalculator {
    ...
    public static void main(String[] args) {
        ...
        switch (choice) {
            ...
            case 6:
                ...
                sortArray(array1, array2, sortOrder);
                break;
            case 7:
    ...
    static int[] performAddition(int[] array1, int[] array2) { //Розрахунок суми введених чисел
        if (array1.length != array2.length) {
            System.out.println("Arrays must have the same length for addition.");
            return null; // Возвращаем null, чтобы показать, что операция не выполнена успешно
        }
        ...
        printArray(result);
        return result; // Возвращаем результат суммирования
    }
    ...
    public static void sortArray(int[] array1, int[] array2, String sortOrder) { //Сортування масиву за зростанням та за спаданням
        switch (sortOrder) {
